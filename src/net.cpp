...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PapaverSomniferum " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PapaverSomniferum is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("PapaverSomniferum-start");
