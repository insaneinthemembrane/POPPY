...
const string strMessageMagic = "PapaverSomniferum Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PapaverSomniferum", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Poppy is born";
        CTransaction txNew;
        txNew.nTime = 1500154111;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	printf("Searching for genesis block...\n");
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x5e9da022aa074a962def9e363da5fd61cdf229ce483564bafb48b9d02653afaa"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd5, 0xa1, 0xb3, 0x25 };
